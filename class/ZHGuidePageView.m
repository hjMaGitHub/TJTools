...
@implementation ZHGuidePageView


- (instancetype)initGuideViewWithImages:(NSArray *)imageNames{
    
    self =[[ZHGuidePageView alloc]initWithFrame:CGRectMake(0, 0, kScreen_width, kKSCREEN_HEIGHT)];
    _isScrollOut = YES;
...
- (UIButton *)getEnterButton
{
    if (!_enterButton) {
        ...
        _enterButton.backgroundColor = RGBCOLOR(177, 242, 194);
